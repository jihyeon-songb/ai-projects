...
import { CODEMONG_IMAGE, type CodemongState } from '../config'
...
/**
 * 코드몽 캐릭터. 상태별로 다른 이미지와 애니메이션을 보여줍니다.
...
export default function Character({ state }: Props) {
  ...
  return (
    ...
    >
      ...
      <img className="character-img" src={CODEMONG_IMAGE[state]} alt="코드몽" draggable={false} />
